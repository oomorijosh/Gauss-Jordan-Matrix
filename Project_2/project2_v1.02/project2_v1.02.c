 ...
 *    Class: EE 160
 *
 * Current objective: (v1.02)
 * ====================
 *    Now that the inputs are collected, Gauss Jordan will be used in order to solve
 *    the problem (a sum function will have to be made) for a polynomial of 1
 *
